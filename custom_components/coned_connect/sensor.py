...
SENSORS = (
    ...
    SensorDescription(
        key="interval_average_power_w",
        name="Latest Interval Average Power",
...
async def async_setup_entry(
    ...
    async_add_entities(IntervalSensor(coordinator, entry, description) for description in SENSORS)


class IntervalSensor(CoordinatorEntity[ConEdisonIntervalCoordinator], SensorEntity):
